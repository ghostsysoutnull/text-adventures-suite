...
public class SpringUtilities
{
    ...
    /**
     * Aligns the first <code>rows</code> * <code>cols</code> components of <code>parent</code> in a grid.
     * Each component in a column is as wide as the maximum preferred width of the components in that
     * column; height is similarly determined for each row. The parent is made just big enough to fit them
     * all.
     * 
     * @param rows
     *            number of rows
