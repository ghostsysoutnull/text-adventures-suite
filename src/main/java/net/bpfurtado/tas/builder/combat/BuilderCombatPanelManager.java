...
public class BuilderCombatPanelManager
{
    ...
    private JPanel createBottonPanel()
    {
        ...
        // helpPn.setMaximumSize(new Dimension(240, 160));
    ...
    private JPanel createToolbar()
    {
        ...
        deleteBt.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {
                ...
                // Selecting the next on the list
    ...
    private JPanel createEditPn()
    {
        ...
        SpringUtilities.makeCompactGrid(editPn, labels.length, 2, // rows, cols
                6, 6, // initX, initY
                6, 6); // xPad, yPad
        return editPn;
    }
    ...
    private JComboBox createCombo()
    {
        ...
        cb.addActionListener(new ActionListener() {
            ...
            {
                /*
                 * Weak logic, but it not duplicated, more than this seemed a bit of over-engineering to me
                 */
